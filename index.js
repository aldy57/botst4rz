...
//
const BotName = 'Dyy Bot 😼'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/bintang_nur_pradana'; // Nama Instagramlu cok
const whatsapplu = '0895-0385-1942'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/BksVrDywRD81iB8RWPnQ3Y'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/BksVrDywRD81iB8RWPnQ3Y'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
